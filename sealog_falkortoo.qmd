...
-   Once logged in, navigate to “System Management” then select “Event Templates.”
    ...
    ![](images/Screenshot%202024-09-18%20113917-3.png){width="348"}
...
-   On the right hand side, the “Create Event Template” will allow you to create a new event.
    ...
    ![](images/Screenshot%202024-09-18%20114137-2.png){width="347"}
...
At the bottom of the “Create Event Template” the ![](images/Screenshot%202024-09-18%20114618-2.png){width="75"} button gives you further options to tailor each event. Each option includes the name of the event option, a drop down requiring you to choose which "type" of option you'd like and the text area.

![](images/Screenshot%202024-09-18%20114715-2.png){width="351"}
...
![](images/Screenshot%202024-09-18%20114858-2.png){width="343"}
...
-   Option Type: Static Text
    ...
    ![](images/Screenshot%202024-09-18%20120706-2.png){width="348"}
    ...
    ![](images/Screenshot%202024-09-18%20123143-2.png){width="350"}
...
-   Option Type: Dropdown
    ...
    ![](images/Screenshot%202024-09-18%20120421-4.png){width="353"}
...
-   Option Type: Checkboxes
    ...
    ![](images/Screenshot%202024-09-18%20123612-3.png){width="348"}
...
-   Option Type: Radio Buttons
    ...
    ![](images/Screenshot%202024-09-18%20123612-4.png){width="347"}
...
-   Options: Required Button
    ...
    ![](images/Screenshot%202024-09-18%20114715-3.png){width="346"}
...
-   Options: Additional Text
    ...
    ![](images/Screenshot%202024-09-18%20123757-2.png){width="351"}

#### Saving and Testing Events

-   Click “Create” to save your event to the “Event Templates.”
    -   ![](images/Screenshot%202024-09-25%20144402.png){width="22" height="21"} Click to edit an Event Template.
    -   ![](images/Screenshot%202024-09-25%20144413.png){width="22" height="18"} Click to test an Event Template.
        -   This is useful when making new events to make sure all your options are configured how you mean them to be.
    -   ![](images/Screenshot%202024-09-25%20144422.png){width="21" height="18"} Click to delete an Event Template.
...
![](images/Screenshot%202024-09-18%20130818-2.png){width="579"}
...
![](images/Screenshot%202024-09-19%20092136-2.png){width="409"}
...
![](images/Screenshot%202024-09-19%20094807-2.png){width="419"}

Maps of the study area and cruise track give location perspective to the cruise.

![](images/Screenshot%202024-09-19%20095006-2.png){width="426"}

#### Underway Systems

Next, a summary of the data received from our underway systems including Weather Data

![](images/Screenshot%202024-09-19%20095348-2.png){width="466"}

![Wind Speed and Direction](images/Screenshot%202024-09-19%20095402-2.png){width="466"}

and Seawater Data

![](images/Screenshot%202024-09-19%20095414-4.png){width="465"}

![Sea Surface Temperature and Salinity](images/Screenshot%202024-09-19%20095426-3.png){width="464"}

#### Event Summary

All of the Sealog events are grouped by event value and quantities are described in this section.

![](images/Screenshot%202024-09-19%20095948-2.png){width="404"}

![](images/Screenshot%202024-09-19%20101751-2.png){width="166"}
...
![](images/Screenshot%202024-09-19%20103744-2.png){width="454"}
