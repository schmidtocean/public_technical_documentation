...
-   Porch configuration (if it changes from dive to dive). **This information should be sent to 'diveplans\@falkortoo.org' prior to every dive.**
...
-   Survey Procedures
-   Waypoints **This information should be sent to 'mt\@falkortoo.org' prior to the mapping survey.**
